  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gbcResumeBankApp.skillLevel.home.createOrEditLabel">
            <Translate contentKey="gbcResumeBankApp.skillLevel.home.createOrEditLabel">Create or edit a SkillLevel</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
