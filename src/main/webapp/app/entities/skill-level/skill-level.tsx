  ...
  return (
    <div>
      <h2 id="skill-level-heading">
        <Translate contentKey="gbcResumeBankApp.skillLevel.home.title">Skill Levels</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gbcResumeBankApp.skillLevel.home.createLabel">Create new Skill Level</Translate>
        </Link>
      </h2>
        ...
        {skillLevelList && skillLevelList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gbcResumeBankApp.skillLevel.home.notFound">No Skill Levels found</Translate>
            </div>
          )
        )}
      </div>
