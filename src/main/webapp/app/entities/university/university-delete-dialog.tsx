...
export const UniversityDeleteDialog = (props: IUniversityDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gbcResumeBankApp.university.delete.question">
        <Translate contentKey="gbcResumeBankApp.university.delete.question" interpolate={{ id: universityEntity.id }}>
