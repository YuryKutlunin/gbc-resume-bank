...
export const ResourcePoolDeleteDialog = (props: IResourcePoolDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gbcResumeBankApp.resourcePool.delete.question">
        <Translate contentKey="gbcResumeBankApp.resourcePool.delete.question" interpolate={{ id: resourcePoolEntity.id }}>
          Are you sure you want to delete this ResourcePool?
        </Translate>
      </ModalBody>
      <ModalFooter>
