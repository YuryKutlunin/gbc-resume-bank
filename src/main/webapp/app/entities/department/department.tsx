  ...
  return (
    <div>
      <h2 id="department-heading">
        <Translate contentKey="gbcResumeBankApp.department.home.title">Departments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gbcResumeBankApp.department.home.createLabel">Create new Department</Translate>
        </Link>
      </h2>
        ...
        {departmentList && departmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="gbcResumeBankApp.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="gbcResumeBankApp.department.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gbcResumeBankApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
