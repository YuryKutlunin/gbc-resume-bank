...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gbcResumeBankApp.department.delete.question">
        <Translate contentKey="gbcResumeBankApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
