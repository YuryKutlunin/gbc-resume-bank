  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gbcResumeBankApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="gbcResumeBankApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="startDateLabel" for="job-history-startDate">
                  <Translate contentKey="gbcResumeBankApp.jobHistory.startDate">Start Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="endDateLabel" for="job-history-endDate">
                  <Translate contentKey="gbcResumeBankApp.jobHistory.endDate">End Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="languageLabel" for="job-history-language">
                  <Translate contentKey="gbcResumeBankApp.jobHistory.language">Language</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="FRENCH">{translate('gbcResumeBankApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('gbcResumeBankApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('gbcResumeBankApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="gbcResumeBankApp.jobHistory.job">Job</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-department">
                  <Translate contentKey="gbcResumeBankApp.jobHistory.department">Department</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-employee">
                  <Translate contentKey="gbcResumeBankApp.jobHistory.employee">Employee</Translate>
                </Label>
