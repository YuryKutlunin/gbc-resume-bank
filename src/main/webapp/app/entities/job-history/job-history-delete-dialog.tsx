...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gbcResumeBankApp.jobHistory.delete.question">
        <Translate contentKey="gbcResumeBankApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
