...
export const EducationDeleteDialog = (props: IEducationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gbcResumeBankApp.education.delete.question">
        <Translate contentKey="gbcResumeBankApp.education.delete.question" interpolate={{ id: educationEntity.id }}>
